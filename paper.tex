...
Experimental results are shown in Figures \ref{fig:ROCdispl_luma}, \ref{fig:ROCdispl_fd}, \ref{fig:ROCdef_grad}, \ref{fig:ROCdef_fd}.

\begin{figure}
\centering
\subfigure[]{\label{fig:buenosAiresDef}\includegraphics[width=0.45\linewidth]{Immagini/ROCdisplacement_luma}}
\subfigure[]{\label{fig:buenosAiresDispl} \includegraphics[width=0.45\linewidth]{Immagini/ROCdisplacement_fd}}
