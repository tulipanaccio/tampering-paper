...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{Immagini/ROCdisplacement_luma}
	\caption[Tampering examples]{Examples of tampering events due to atmospheric phenomena. In Figure \ref{fig:neve} there is an occlusion due to some snow on the camera lens, while in Figure \ref{fig:pioggia} there is a blur due to rain drops on the camera lens.}
	\label{fig:ROCdispl_luma}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{Immagini/ROCdisplacement_fd}
	\caption[Tampering examples]{Examples of tampering events due to atmospheric phenomena. In Figure \ref{fig:neve} there is an occlusion due to some snow on the camera lens, while in Figure \ref{fig:pioggia} there is a blur due to rain drops on the camera lens.}
	\label{fig:ROCdispl_fd}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{Immagini/ROCdefocus1}
	\caption[Tampering examples]{Examples of tampering events due to atmospheric phenomena. In Figure \ref{fig:neve} there is an occlusion due to some snow on the camera lens, while in Figure \ref{fig:pioggia} there is a blur due to rain drops on the camera lens.}
	\label{fig:ROCdispl_luma}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{Immagini/ROCdefocus_fd}
	\caption[Tampering examples]{Examples of tampering events due to atmospheric phenomena. In Figure \ref{fig:neve} there is an occlusion due to some snow on the camera lens, while in Figure \ref{fig:pioggia} there is a blur due to rain drops on the camera lens.}
	\label{fig:ROCdispl_luma}
\end{figure}
