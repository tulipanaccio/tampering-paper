...
\begin{figure}
\centering
\subfigure[]{\label{fig:buenosAiresDef} \includegraphics[width=1\linewidth]{Immagini/buenosAiresDef}}
\subfigure[]{\label{fig:buenosAiresDispl} \includegraphics[width=1\linewidth]{Immagini/buenosAiresDispl}}
